...
public final class UctConfig {
    ...
    protected static void parseArgs(final String[] args) {
        ...
        MAX_NODES = ap.getValue(new String[]{"-n", "-nodes"}, MAX_NODES);
        AVG_COMP_SIZE = ap.getValue(new String[]{"-a", "-avg"}, AVG_COMP_SIZE);
        STDEV_COMP_SIZE = ap.getValue(new String[]{"-s", "-stdev"}, STDEV_COMP_SIZE);
        BINOMIAL_PARAM = ap.getValue(new String[]{"-b", "-binomial"}, BINOMIAL_PARAM);
        URGENT_NODE_PERCENT = ap.getValue(new String[]{"-u", "-urgent"}, URGENT_NODE_PERCENT);
