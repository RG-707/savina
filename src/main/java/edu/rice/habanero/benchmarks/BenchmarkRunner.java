...
public class BenchmarkRunner {
    ...
    protected static boolean no_evaluation = false;
    ...
    private static void parseArgs(final String[] args) throws Exception {
        ...
        iterations = argParser.getValue(new String[]{"-iter", "--iterations"}, iterations);
        no_evaluation = argParser.getValue(new String[]{"--no_evaluation"}, no_evaluation);
    }
    ...
    public static void runBenchmark(final String[] args, final Benchmark benchmark) {
        ...
        if (no_evaluation) {
            for (int i = 0; i < iterations; i++) {
                ...
                benchmark.cleanupIteration(i + 1 == iterations, 0);
            }
            return;
        }
