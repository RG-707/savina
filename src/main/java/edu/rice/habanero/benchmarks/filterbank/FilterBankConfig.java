...
public final class FilterBankConfig {
    ...
    protected static void parseArgs(final String[] args) {
        ...
        NUM_SIMULATIONS = ap.getValue(new String[]{"-s", "-sim", "-simulation"}, NUM_SIMULATIONS);
        NUM_COLUMNS = ap.getValue(new String[]{"-c", "-col", "-columns"}, NUM_COLUMNS);
        {
            final int argInt = ap.getValue(new String[]{"-a", "-chan", "-channels"}, NUM_CHANNELS);
