...
public final class SortedListConfig {
    ...
    protected static void parseArgs(final String[] args) {
        ...
        NUM_ENTITIES = ap.getValue("-e", NUM_ENTITIES);
        NUM_MSGS_PER_WORKER = ap.getValue("-m", NUM_MSGS_PER_WORKER);
        WRITE_PERCENTAGE = ap.getValue("-w", WRITE_PERCENTAGE);
        SIZE_PERCENTAGE = ap.getValue("-s", SIZE_PERCENTAGE);
